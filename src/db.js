    ...
    var db = {
        "chars": {
            ...
            'lyney': { 
                ...
                'burst': "Wondrous Trick: Miracle Parade\n3 Pyro, 2 Energy\nDeals 3 Pyro DMG, summons 1 Grin-Malkin Hat, adds 1 stack of Prop Surplus.", 
                'special': "Normal Attack: Prop Arrow \n3 Pyro \nDeals 2 Pyro DMG and summons Grin-Malkin Hat. \nHowever, if this character's HP is higher than the opposing active character\'s, they will gain 1 stack of Prop Surplus, and then take 1 Piercing DMG.", 
            ...
            'lynette': {
                'name': 'Lynette',
                'na': "Rapid Ritesword \n2 Black, 1 Anemo \nDeals 2 Physical DMG.",
                'skill': "Enigmatic Feint \n3 Anemo \nDeals 3 Anemo DMG. The first time this Skill is used this Round, heal the user for 2 HP if not at full HP, but apply Overawing Assault to the user.",
        ...
        "actions": {
            ...
            'painforpain': { 
                ...
                'cost': '3 White',
                'description': "Can only be played if your active character is Signora: When entering play, generate 3 Elemental Dice of the same Type as Signora. \n\nWhen this character takes at least 3 DMG: Negates 1 DMG, then apply Sheer Cold or Blazing Heat to the opposing active character based on Signora's state. (Once per Round) \n(Your deck must contain Signora to add this card to your deck)",
            ...
            'gildeddreams': { 
                ...
                'cost': '3 Black',
                'description': "When played: Draw a card and generate 1 Die of the same Element as the attached character. If you have 3 different Elemental Types in your party, generate 1 more Omni Die. \n\nWhen the character to which this card is attached is your active character, then when an opposing character takes DMG: Draw a card. (Once per Round) \n\n(A character can equip a maximum of 1 Artifact)",
            ...
            'heartofkhvarenasbrilliance': { 
                ...
                'cost': '0 White',
                'description': "After this character takes DMG: Draw 1 card. (Once per Round) \n\n(A character can equip a maximum of 1 3004_BuffArtifact)",
            ...
            'seeddispensary': { 
                ...
                'cost': '0 White',
                'description': "When you play an Equipment or Support Card with an original cost of at least 1 Elemental Die: Spend 1 less Elemental Die. (Once per Round)\nUsage(s): 2",
            ...
            'theboarprincess': { 
                ...
                'cost': '0 White',
                'description': "Each time you unequip an Equipment Card from one of your characters: Gain 1 Omni Element. (Max 3)\n(This effect can be triggered by the loss of an Equipment Card from a character falling or from having a equipped Weapon or an Artifact being overwritten.)",
        ...
        "misc": {
            ...
            'curtainofslumbershield': {
                ...
                "type": 'Combat Status',
                "description": "Provides 2 points of Shield to your active character.",
                'related': 'Layla',
            },
            'shootingstar': {
                "name": 'Shooting Star',
                "type": 'Combat Status',
                "description": "After one of your characters uses a Skill: Gain 1 Night Star. If possible, consume 3 Night Stars to deal 1 Cryo DMG.",
                'related': 'Layla',
            },
            'celestialdreamsphere': {
                "name": 'Celestial Dreamsphere',
                "type": 'Summon',
                "description": "End Phase: Deal 1 Cryo DMG. If Shooting Star is in play, it will gain 1 Night Star.\n\nUsage(s): 2",  
                'related': 'Layla',
            },
            'exquisitethrow': {
                "name": 'Exquisite Throw',
                "type": 'Combat Status',
                "description": "After your character uses a Normal Attack: Deal 1 Hydro DMG. If only 1 Duration (Rounds) is left, this DMG increases by 1.\n\nDuration (Rounds): 2",
                'related': 'Yelan',
            },
            'breakthrough': {
                "name": 'Breakthrough',
                "type": 'Status',
                "description": "This state starts with 1 Breakthrough stack. When re-attached, add 1 Breakthrough stack. Breakthrough can have a maximum of 3 stacks.\nEnd Phase: Gain 1 Breakthrough stack.\n\nWhen the character to which this is attached performs a Charged Attack: If possible, consume 2 Breakthrough stacks to convert Physical DMG dealt into Hydro DMG and draw 1 card.",
                'related': 'Yelan',
            },
            'propsurplus': {
                "name": 'Prop Surplus',
            ...
            'bogglecatbox': {
                "name": 'Bogglecat Box',
                "type": 'Summon',
                "description": "End Phase: Deals 1 Anemo DMG.\n\nUsage(s): 2\n\nWhen your active character takes DMG: Decreases DMG taken by 1. (Once per Round)\nWhen your character(s) take Cryo/Hydro/Pyro/Electro DMG: Change the Elemental Type of this card. (Once before leaving play)",
                'related': 'Lynette',
            },
            'generalswarbanner': {
                "name": "General's War Banner",
                "type": 'Combat Status',
                "description": "Your character's Geo DMG dealt +1.\n\nDuration (Rounds): 2 (Can stack, stack to 3 Rounds)",
                'related': 'Gorou',
            },
            'generalsglory': {
            ...
            'spiritofomen:pyroscorpion': {
                ...
                "type": 'Summon',
                "description": "End Phase: Deal 1 Pyro DMG.\n\nUsage(s): 2\n\nWhen this Summon is on the field: Eremite Scorching Loremaster takes -1 DMG. (Once per Round)",
            ...
            'stonefacets:elementalcrystallization': {
                ...
                "type": 'Status',
                "description": "After this character takes Cryo/Hydro/Pyro/Electro DMG: If this character current has not absorbed the power of this element, then this character Absorbs the corresponding element's power.\nUsage(s): 1",
                'related': 'Azhdaha',
            },
            'stonefacets:elementalabsorption': {
                "name": 'Stone Facets: Elemental Absorption',
                "type": 'Status',
                "description": "The character can absorb the power of the Elements, including Cryo/Hydro/Pyro/Electro, and then based on the element absorbed, gain the skills Frostspike Wave/Torrential Rebuke/Blazing Rebuke/Thunderstorm Wave. (The character can only have one Elemental Type absorbed at once)\nAfter this character absorbs an element of a different type than the currently absorbed element: Generate 1 Elemental Die of the type of the Element that was just absorbed.",
                'related': 'Azhdaha',
            },
            'fourleafsigil': {
