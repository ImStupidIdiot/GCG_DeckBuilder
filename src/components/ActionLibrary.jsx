...
class ActionLibrary extends Component {  
    ...
    search() {
        ...
        var displayActions = [...this.state.allActions];
        displayActions = displayActions.filter((action) => db.actions[action].description.toLowerCase().includes(text.toLowerCase()) || db.actions[action].name.toLowerCase().includes(text.toLowerCase()) || db.actions[action].cost.toLowerCase().includes(text.toLowerCase()) || db.actions[action].flavor.toLowerCase().includes(text.toLowerCase()) || (db.actions[action].keyword && db.actions[action].keyword.toLowerCase().includes(text.toLowerCase())));
